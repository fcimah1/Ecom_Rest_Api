...
<body>
    <div>
        <div style="background: #eceff4;padding: 1rem;">
            ...
            <table>
                <tr>
                    <td style="font-size: 1rem;" class="strong">Elivera</td>
                    <td class="text-right"></td>
                </tr>
                <tr>
                    <td class="gry-color small">my adress test </td>
                    <td class="text-right"></td>
                </tr>

                <tr>
                    <td class="gry-color small">{{ translate('Email') }}: test@test.com</td>
                    <td class="text-right small"><span class="gry-color small">{{ translate('Order ID') }}:</span> <span
                            class="strong">{{ $order->code }}</span></td>
                </tr>
                <tr>
                    <td class="gry-color small">{{ translate('Phone') }}: 01011110000</td>
